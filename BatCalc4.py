...
CapFactor = st.sidebar.slider("Capacity Factor / %", min_value=0.0, max_value=100.0, value=50.0)
EnergyPrice = st.sidebar.slider("Energy Price / $", min_value=0.0, max_value=100.0, value=30.0)
PTCRate = st.sidebar.slider("PTC Rate / $", min_value=0.0, max_value=100.0, value=25.0)
PTCYears = st.sidebar.slider("PTC Years From Start", min_value=0.0, max_value=25.0, value=10.0)
ProjLifetime = st.sidebar.slider("Project Lifetime", min_value=0.0, max_value=25.0, value=25.0)
CurtLoss = st.sidebar.slider("Bat Curtailment Loss / %", min_value=0.0, max_value=15.0, value=2.0)
IntRate = st.sidebar.slider("Interest Rate / %", min_value=0.0, max_value=15.0 value=8.0)
