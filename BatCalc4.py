...
TBAvail = st.sidebar.slider("Time Based Availability / %", min_value=0.00, max_value=100.00, value=98.00)
...
ProjLifetime = st.sidebar.slider("Project Lifetime", min_value=0, max_value=35, value=25)
